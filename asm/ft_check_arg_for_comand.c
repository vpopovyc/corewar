...
{
    if (!ft_strcmp(n, LIVE) || !ft_strcmp(n, ZJMP) || !ft_strcmp(n, LFORK) || !ft_strcmp(n, AFF) || !ft_strcmp(n, FORK))
        ...
        (op != 84 && op != 100 && op != 116 && op != -108 && op != -92 && op != -76 && op != -44 && op != -12 && op != -28) ? ft_error(11) : 0;
    else if (!ft_strcmp(n, LDI))
        (op != 100 && op != 84 && op != -92 && op != -108 && op != -28 && op != -44) ? ft_error(11) : 0;
    else if (!ft_strcmp(n, STI))
        (op != 88  && op != 84 && op != 104 && op != 100 && op != 120 && op != 116) ? ft_error(11) : 0;
